 ...
 */
final class Version20240719161228 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipes CHANGE instructions instructions VARCHAR(10000) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipes CHANGE instructions instructions VARCHAR(255) NOT NULL');
    }
}
